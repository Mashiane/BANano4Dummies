...
Public Sub Initialize(sID As String) As MiniDrawer
	ID = sID.tolowercase
...
Sub AddItem(itmID As String, href As String, Text As String) As MiniDrawer
	Dim a As UOENowHTML
...
Sub AddItem1(href As String, itmID As String, Text As String) As MiniDrawer
	Dim a As UOENowHTML
	a = BANanoMiniCSSCode.CreateAnchor(itmID).SetHREF(href).SetText(Text)
	Nav.AddElement(a)
	Return Me
